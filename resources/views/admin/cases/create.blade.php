<x-app-layout>
    <div class="px-4 py-6 sm:px-6 lg:px-8"><div class="mx-auto max-w-3xl">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-950">Create Case</h1>
                <p class="text-sm text-slate-500">Create a new case without leaving the dashboard.</p>
            </div>
