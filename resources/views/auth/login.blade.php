...
<head>
    ...
    <title>Admin Login - {{ config('app.name', 'Prahari') }}</title>
...
<body>
    ...
    <div class="glass-container">
        <h2>Welcome Back</h2>
        <p class="subtitle">Sign in to manage Prahari cases and reports.</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="text-center">
                <a class="link" href="{{ route('register') }}">Create admin account</a>
            </div>
        </form>
    </div>
</body>
